...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const UNIFIED_GAS_URL = 'https://script.google.com/macros/s/AKfycb_2YlFZxcguMTtBTTfrD9CN6M1HhXRaXvuGe83N2yM5FmGXYh2qornjVPJ_Bb5LmxD/exec';
        ...
        aiGenerateBtn.addEventListener('click', () => {
            ...
            const startSovereignEngineV38 = async () => {
                ...
                const tryGasProxy = async (prompt) => {
                    const GAS_URLS = [
                        'https://script.google.com/macros/s/AKfycbz6yAzc0cB46SDOsxw60EciI8IgkLp2Rfr_NAl-oYAImnWJHjLuuzrPHPo28F_t4bFY/exec'
                    ];
